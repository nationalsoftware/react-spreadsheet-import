...
export const f1099nec = [
    ...
    },
    {
        ...
        example: "TRUE",
        description: "Indicator that payer was notified by the IRS twice within 3 calendar years that the payee provided an incorrect TIN.",
        ...fieldTypes.checkbox,
    },
    {
